...
class Item:
    ...
    def display(self, surface, selection_nr, name, value, max_value, cost):
        ...
        self.display_names(surface, name, cost, self.index == selection_nr)
        self.display_bar(surface, value, max_value, self.index == selection_nr)